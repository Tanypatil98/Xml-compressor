	...
	<body>
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="myNavbar">
			      <ul class="nav navbar-nav">
			        <li><a href="home.php">Compressor</a></li> 
			        <li class="active"><a href="decomp.php">Decompressor</a></li>
		...
		<div class="container">
			...
			<br />
				...
				<hr>
			<?php } ?>
			<h1 align="center">Decompress a Xml File</h1>
			<br />
			<div class="panel panel-default">
				<div class="panel-heading"><b>Decompress to get original XML quality file</b></div>
				<div class="panel-body">
					<form id="uploadImage" action="decom.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="dropzone-wrapper">
				              ...
				              <input type="file" name="uploadFile" class="dropzone" id="uploadFile" accept=".xml" multiple />
				            </div>
